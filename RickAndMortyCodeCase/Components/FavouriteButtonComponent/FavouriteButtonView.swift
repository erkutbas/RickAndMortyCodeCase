...
class FavouriteButtonView: GenericBaseView<FavouriteButtonViewData> {
    ...
    private lazy var imageView: UIImageView = {
        ...
        temp.tintColor = CodeCaseColor.defaultBackground.value
    ...
    private func colorManager() {
        ...
        if data.state {
            imageView.tintColor = CodeCaseColor.Red.value
        } else {
            imageView.tintColor = CodeCaseColor.defaultBackground.value
        }
    }
